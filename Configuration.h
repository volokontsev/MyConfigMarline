...
#define STRING_CONFIG_H_AUTHOR "(Aleksei Volokontsev)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 798 }
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X -8981
  #define TOUCH_CALIBRATION_Y -12316 
  #define TOUCH_OFFSET_X        257
